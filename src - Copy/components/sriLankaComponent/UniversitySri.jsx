...
import SriTrendingArticles from './SriTrendingArticles';
import UniversityComparisonSri from './UniversityComparisonSri';
import BannerSri from './BannerSri';
...
const FactsGrid = () => {
  ...
  const whyStudyData = {
    title: "Why Study in Sri Lanka?",
    description: `The Sri Lanka is home to the world's most esteemed universities and is among the popular destinations 
                  for studying abroad. Ranked as the best education systems in the world, the Sri Lankan Education System provides 
