...
const SriStudyRequirements = () => {
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto p-6 bg-white rounded-xl shadow-md">
      <h1 className="text-2xl font-bold mb-4 text-left">Admission Requirements for Sri Lanka Study Abroad</h1>
      <p className="text-gray-600 mb-6 text-left">
        Here are the major requirements to study in Sri Lanka which you need to ensure while applying to a Sri Lanka university:
      </p>
...
export default SriStudyRequirements;