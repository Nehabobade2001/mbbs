...
const OperatorCard = ({ name, company, image }) => (
  <div className="bg-white rounded-2xl shadow-lg overflow-hidden w-50"> {/* Fixed width */}
    ...
    <div className="p-3 bg-[#233871] text-white"> {/* Updated background color */}
      <h3 className="font-semibold text-lg text-black">{name}</h3> {/* Name in black */}
...
const OperatorGrid = () => (
  <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8"> {/* Responsive padding */}
    <h2 className="text-3xl font-semibold mb-6 text-left text-[#233871] font-poppins">Individual Operators</h2> {/* Title in #233871 */}
