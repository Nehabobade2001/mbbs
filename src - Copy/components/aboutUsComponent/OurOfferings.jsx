  ...
  return (
    <div className="bg-slate-50 py-16 relative overflow-hidden ">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-semibold text-[#233871] mb-4 font-poppins">Our Offerings</h2>
        <h3 className="text-4xl font-semibold text-black mb-12 max-w-3xl font-poppins">
          We <span className="text-[#f6c16f] font-poppins">simplify international admissions</span> for students, universities & our partners
        </h3>
