...
const VisaScroller = () => {
  ...
  const visaData = [
    {
      ...
      cost: "£339",
      type: "Study",
      description: "This category is for students coming to the AUSTRALIA for post-16 education. A Tier 4 (General) Student must be at least 16 years old.",
      image: one,
    },
    {
    ...
    },
    {
      ...
      cost: "£97",
      type: "Study",
      description: "For students enrolling in a short course (up to 6 months) in the AUSTRALIA.",
      image: one,
    },
    {
      title: "Graduate Visa",
      ...
      description: "This visa allows you to stay and work in the AUSTRALIA for up to 2 years after completing your studies.",
      image: two,
    }
  ];
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 relative">
      ...
      <h2 className="text-xl font-semibold mb-6" style={{ color: '#233871' }}>Visa for AUSTRALIA</h2>
      ...
      <div className="relative w-full">
        <div className="flex items-center justify-between relative">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-[-40px] z-10 p-4 top-1/2 transform -translate-y-1/2 rounded-full bg-[#233871] text-white hover:bg-[#1a2b5f]"
          >
          ...
          <div className="flex transition-transform duration-500 ease-in-out overflow-hidden">
            <div className="flex" style={{ transform: `translateX(-${currentIndex * 50}%)` }}>
              {visaData.map((visa, index) => (
                <div key={index} className="w-full sm:w-1/2 px-4 flex-shrink-0">
                  <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col sm:flex-row h-full">

                    {/* Visa Image */}
                    <div className="w-full h-48 sm:w-1/2 sm:h-full">
                      <img
                        src={visa.image}
                        alt={visa.title}
          ...
          <button
            onClick={nextSlide}
            className="absolute right-[-40px] z-10 p-4 top-1/2 transform -translate-y-1/2 rounded-full bg-[#233871] text-white hover:bg-[#1a2b5f]"
          >
