...
import Capital from '../../Images/Australia/Capital.png';
...
const FactsGrid = () => {
  const factsData = [
    { imageSrc: Capital, title: "Capital", value: "Canberra" },
    { imageSrc: Population, title: "Population", value: "26 Mn" },
    { imageSrc: Language, title: "Language", value: "English" },
    { imageSrc: Students, title: "International Students", value: "869,709" },
    { imageSrc: GDP, title: "GDP", value: "$ 1.37 Trillion" },
    { imageSrc: Dialing, title: "Dialing Code", value: "+61" },
    { imageSrc: Currency, title: "Currency", value: "Australian Dollar" },
    { imageSrc: University, title: "Universities and Colleges", value: "43" },
  ];
