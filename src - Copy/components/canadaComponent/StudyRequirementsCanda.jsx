...
const CanadaStudyRequirements = () => {
  ...
  return (
    ...
    <div className="max-w-6xl mx-auto p-6 bg-white rounded-xl shadow-md">
      <h1 className="text-2xl font-bold mb-4 text-left">Admission Requirements for Canada Study Abroad</h1>
...
export default CanadaStudyRequirements;