...
const visaOptions = [
  {
    ...
    cost: "Rs 339",
    type: "Study",
    description: "This category is for students coming to the Canada for post-16 education. A Tier 4 (General) Student must be at least 16 years old.",
    color: "bg-purple-100"
  },
  {
    ...
    cost: "Rs 339",
    type: "Study",
    description: "You can apply for this Tier 4 (Child) student visa if you're aged between 4 and 17 and you want to study at an independent school in the Canada.",
    color: "bg-blue-100"
  },
...
const weatherData = [
  { city: "Barrie", min: 10, max: 16 },
  { city: "Kelowna", min: 6, max: 13 },
  { city: "Toronto", min: 9, max: 15 },
  { city: "Vancouver", min: 8, max: 12 },
  { city: "Edmonton", min: 8, max: 14 },
  { city: "Calgary", min: 6, max: 14 },
  { city: "Victoria", min: 7, max: 14 },
  { city: "Saskatoon", min: 8, max: 20 },
  { city: "Kingston", min: 6, max: 15 },
  { city: "Edmonton", min: 10, max: 14 },
];
    ...
    <div className="max-w-6xl mx-auto p-6 bg-gray-100">
      ...
      <div className="grid grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4 text-[#233871]">Visa for Canada</h2>
        ...
        {/* Cost of Living */}
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4 text-[#233871]">Cost Of Living in Canada</h2>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          <h2 className="text-xl font-semibold mb-4 text-[#233871]">Monthly Living Expenses in Canada</h2>
          <div className="grid grid-cols-2 gap-4">
