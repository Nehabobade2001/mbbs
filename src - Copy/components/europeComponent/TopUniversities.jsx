...
const FactsGrid = () => {
  const factsData = [
    { imageSrc: Capital, title: "Capital", value: "Brussels" },
    { imageSrc: Population, title: "Population", value: "448 Mn" },
    { imageSrc: Language, title: "Language", value: "English, German, French and Spanish" },
    { imageSrc: Students, title: "International Students", value: "1.52 Million" },
    { imageSrc: GDP, title: "GDP", value: "$ 19.35 Trillion" },
    { imageSrc: Dialing, title: "Dialing Code", value: "Varies" },
    { imageSrc: Currency, title: "Currency", value: "Euro" },
    { imageSrc: University, title: "Universities and Colleges", value: "2,706" },
  ];
