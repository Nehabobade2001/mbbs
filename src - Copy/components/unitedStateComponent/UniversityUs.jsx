...
import UsTrendingArticles from './UsTrendingArticles';
import UniversityComparisonUs from './UniversityComparisonUs';
...
const FactsGrid = () => {
  ...
  const whyStudyData = {
    title: "Why Study in United State?",
    description: `The United State is home to the world's most esteemed universities and is among the popular destinations 
                  for studying abroad. Ranked as the best education systems in the world, the United Staten Education System provides 
