...
import UsStudyRequirements from './StudyRequirementsUs';
...
const UsAdmissionTimeline = () => {
  ...
  const data = {
    UG: {
      ...
      popularUniversities: [
        { src: "/api/placeholder/100/50", alt: "University of New York" },
        { src: "/api/placeholder/100/50", alt: "University of Michigan" },
        { src: "/api/placeholder/100/50", alt: "Imperial College California" },
        { src: "/api/placeholder/100/50", alt: "Nevada" },
        { src: "/api/placeholder/100/50", alt: "Colorado University" },
        { src: "/api/placeholder/100/50", alt: "University of Alaska" },
      ],
    },
    Masters: {
      ...
      popularUniversities: [
        { src: "/api/placeholder/100/50", alt: "University of New York" },
        { src: "/api/placeholder/100/50", alt: "University of Nevada" },
        { src: "/api/placeholder/100/50", alt: "Imperial College California" },
        { src: "/api/placeholder/100/50", alt: "Michigan" },
        { src: "/api/placeholder/100/50", alt: "Colorado University" },
        { src: "/api/placeholder/100/50", alt: "University College Alaska" },
      ],
    },
    MBA: {
...
export default UsAdmissionTimeline;
