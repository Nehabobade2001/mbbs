...
import Capital from '../../Images/Dubai/Capital.png';
...
const FactsGrid = () => {
  const factsData = [
    { imageSrc: Capital, title: "Capital", value: "UAE" },
    { imageSrc: Population, title: "Population", value: "10 Million" },
    { imageSrc: Language, title: "Language", value: "Arabic" },
    { imageSrc: Students, title: "International Students", value: "70,346" },
    { imageSrc: GDP, title: "GDP", value: "$ 32+ Billion" },
    { imageSrc: Dialing, title: "Dialing Code", value: "+971" },
    { imageSrc: Currency, title: "Currency", value: "Dubai Dirham" },
    { imageSrc: University, title: "Universities and Colleges", value: "80+" },
  ];
