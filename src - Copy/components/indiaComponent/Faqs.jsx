...
const FAQSection = () => {
  ...
  const faqs = [
    {
      question: "How much does it cost to study in India?",
      answer: "The fees for courses vary across different universities in the India. The average cost of UG courses in India range from £9,000- 30,000 (INR 9,00,000-30,00,000). The fees for PG courses is around £15,000-35,000 (INR 15,00,000-35,00,000). MBA courses in India cost around £12,000- 80,000 (INR 12,00,000-80,00,000)."
    },
    {
      question: "Is it possible to study in India without IELTS?",
    ...
    {
      question: "Can one work part-time while studying in India?",
    ...
    {
      question: "What is the minimum percentage required to study in the India?",
    ...
    {
      question: "Which are the best courses to study in the India?",
    ...
    {
      question: "Which are the top universities in the India?",
      answer: "Some top universities include Oxford, Cambridge, Imperial College London, UCL, and LSE, among others."
    },
    {
      question: "How long can one stay after studying in the India?",
