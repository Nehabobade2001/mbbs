...
import Capital from '../../Images/Italy/Capital.png';
...
const FactsGrid = () => {
  const factsData = [
    { imageSrc: Capital, title: "Capital", value: "Rome" },
    { imageSrc: Population, title: "Population", value: "58 Million" },
    { imageSrc: Language, title: "Language", value: "Italian" },
    { imageSrc: Students, title: "International Students", value: "109,681" },
    { imageSrc: GDP, title: "GDP", value: "$ 2.05 Trillion" },
    { imageSrc: Dialing, title: "Dialing Code", value: "+39" },
    { imageSrc: Currency, title: "Currency", value: "Euro" },
    { imageSrc: University, title: "Universities and Colleges", value: "102" },
  ];
