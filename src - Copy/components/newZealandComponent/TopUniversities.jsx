...
import Capital from '../../Images/NewZealand/Capital.png';
...
const FactsGrid = () => {
  const factsData = [
    { imageSrc: Capital, title: "Capital", value: "Wellington" },
    { imageSrc: Population, title: "Population", value: "5.1 Million" },
    { imageSrc: Language, title: "Language", value: "English, Maori" },
    { imageSrc: Students, title: "International Students", value: "61,240" },
    { imageSrc: GDP, title: "GDP", value: "$ 201 Billion" },
    { imageSrc: Dialing, title: "Dialing Code", value: "64" },
    { imageSrc: Currency, title: "Currency", value: "New Zealand Dollar" },
    { imageSrc: University, title: "Universities and Colleges", value: "226" },
  ];
