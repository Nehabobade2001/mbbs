...
const ThirdSection = () => {
  const cards = [
    ...
    },
    {
      ...
      tittle: "PTE Live Online Training",
    ...
    },
    {
      ...
      tittle: "PTE Self-Paced Online Training",
  ...
  return (
    <div className="min-h-[85vh]  px-20 bg-gray-50">
      ...
      <div className="text-center text-2xl sm:text-3xl">
        ...
        PTE Prep <span className="text-[#F6C16D]">Courses</span> 
        </h1>
        <p className="opacity-80 text-base sm:text-lg mt-2 text-slate-600 font-light">
          Pick the PTE coaching that works best for you
        </p>
      </div>
