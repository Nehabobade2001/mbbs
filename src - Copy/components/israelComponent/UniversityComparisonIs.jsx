...
const UniversityComparison = () => {
  const universities = [
    { 
      name: 'The University of Indore', 
      location: 'Indore, Israel', 
      ielts: 6, 
      ranking: 32,
      imageSrc: 'https://assets.leverageedu.com/school-logo/logo_1643635379279.jpeg' // Example logo
    },
    { 
      name: 'University of Bhopal', 
      location: 'Bhopal, Israel', 
      ielts: 6, 
      ranking: 64,
  ...
  return (
    <div className="max-w-6xl mx-auto p-6"> {/* Increased max width of container */}
      <h1 className="text-2xl font-bold text-center mb-8 text-[#233871]">Top Universities to Study in Israel</h1>
