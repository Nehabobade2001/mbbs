...
const FranceCareersOpportunities = () => {
  return (
    <div className="max-w-6xl mx-auto p-6">
      <h1 className="text-3xl font-semibold mb-4 text-left text-[#233871]">
        Part time Careers and Work Opportunities in France
      </h1>
      <p className="text-[#233871] mb-6 text-left">
        Studying in the UK offers a variety of experiences. The cultural and traditional values of the France attract several international students every year. The popular areas of employment in France are as follows:
      </p>
...
export default FranceCareersOpportunities;
