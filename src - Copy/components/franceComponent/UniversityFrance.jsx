...
import FranceTrendingArticles from './FranceTrendingArticles';
import UniversityComparisonFrance from './UniversityComparisonFrance';
import BannerFrance from './BannerFrance';
...
const FactsGrid = () => {
  ...
  const whyStudyData = {
    ...
    description: `The France is home to the world's most esteemed universities and is among the popular destinations 
                  for studying abroad. Ranked as the best education systems in the world, the Francen Education System provides 
  ...
  return (
    <>
      ...
      <FranceTrendingArticles />
      <BannerFrance />
      <UniversityComparisonFrance />
    </>
  );
};
