...
import FranceStudyRequirements from './StudyRequirementsFrance';
...
const FranceAdmissionTimeline = () => {
  ...
  const data = {
    UG: {
      ...
      popularUniversities: [
        { src: "/api/placeholder/100/50", alt: "University of Paris" },
        { src: "/api/placeholder/100/50", alt: "University of Grenoble" },
        { src: "/api/placeholder/100/50", alt: "Imperial College Avignon" },
        { src: "/api/placeholder/100/50", alt: "Lille" },
...
export default FranceAdmissionTimeline;
