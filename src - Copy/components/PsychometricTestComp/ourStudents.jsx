...
const CountryCard = ({ name, flag, offers }) => (
  <div className="bg-white rounded-lg shadow-md p-4 text-center">
    ...
    <h3 className="font-semibold text-[#233871]">{name}</h3>
...
const OurStudents = () => (
  <section className="bg-slate-50 py-12">
    <div className="container mx-auto px-4">
      <h2 className="text-2xl font-bold text-[#233871] mb-2 pl-20">Our Students</h2>
      <h3 className="text-3xl font-bold text-black mb-8 pl-20">Across the globe</h3>
