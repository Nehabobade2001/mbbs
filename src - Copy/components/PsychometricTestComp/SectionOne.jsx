...
const SectionOne
 = () => {
  return (
    ...
    >
      <div className="flex items-center justify-center h-full px-6 md:px-16 pt-24"> {/* Added pt-24 for padding */}
        <div className="text-black max-w-lg text-center"> {/* Centering text */}
          
          {/* Mission Statement */}
          <h1 className="text-4xl md:text-5xl font-semibold mb-4 text-[#233871]">Our Mission</h1>
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-[#233871]">
          ...
          <p className="mt-2 text-gray-500 text-center">and more</p> {/* Centering text */}
