...
import JapanTrendingArticles from './JapanTrendingArticles';
import UniversityComparisonJapan from './UniversityComparisonJapan';
import BannerJapan from './BannerJapan';
...
const FactsGrid = () => {
  ...
  const whyStudyData = {
    title: "Why Study in Japan?",
    description: `The Japan is home to the world's most esteemed universities and is among the popular destinations 
                  for studying abroad. Ranked as the best education systems in the world, the Japann Education System provides 
  ...
  return (
    <>
      ...
      <JapanTrendingArticles />
      <BannerJapan />
      <UniversityComparisonJapan />
    </>
  );
};
