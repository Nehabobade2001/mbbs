...
import JapanStudyRequirements from './StudyRequirementsJapan';
...
const JapanAdmissionTimeline = () => {
  ...
  const data = {
    UG: {
      ...
      popularUniversities: [
        { src: "/api/placeholder/100/50", alt: "University of Kanazawa" },
        { src: "/api/placeholder/100/50", alt: "University of Nagoya" },
        { src: "/api/placeholder/100/50", alt: "Imperial College Tokyo" },
        { src: "/api/placeholder/100/50", alt: "Sendai" },
...
export default JapanAdmissionTimeline;
