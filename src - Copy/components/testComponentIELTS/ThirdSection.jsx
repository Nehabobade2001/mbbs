  ...
  const cards = [
    {
      ...
      tittle: "IELTS Classroom Training",
    ...
    },
    {
      ...
      tittle: "IELTS Live Online Training",
    ...
    },
    {
      ...
      tittle: "IELTS Self-Paced Online Training",
  ...
  return (
    <div className="min-h-[85vh]  px-20 bg-gray-50">
      ...
      <div className="text-center text-2xl sm:text-3xl">
        ...
        IELTS Prep <span className="text-[#F6C16D]">Courses</span> 
        </h1>
        <p className="opacity-80 text-base sm:text-lg mt-2 text-slate-600 font-light">
          Pick the IELTS coaching that works best for you
        </p>
      </div>
