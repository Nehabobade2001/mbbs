  ...
  const visaData = [
    {
      ...
      cost: "£339",
      type: "Study",
      description: "This category is for students coming to the SPAIN for post-16 education. A Tier 4 (General) Student must be at least 16 years old.",
      image: one,
    },
    {
    ...
    },
    {
      ...
      cost: "£97",
      type: "Study",
      description: "For students enrolling in a short course (up to 6 months) in the SPAIN.",
      image: one,
    },
    {
      title: "Graduate Visa",
      ...
      description: "This visa allows you to stay and work in the SPAIN for up to 2 years after completing your studies.",
      image: two,
    }
  ];
