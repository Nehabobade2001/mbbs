...
const Navbar = () => {
  ...
  return (
    <>
      <nav
        //  { scrolled ? `className="fixed top-10 w-full bg-transparent z-40 shadowmd " :  className="fixed top-10 w-full bg-transparent z-40 shadowmd "`}
        className={`fixed top-10 w-full z-40 ${
          !scrolled ? "bg-transparent shadowmd" : "bg-white shadow-none"
        }`}
      >
        <div className="max-w-full m-2 px-2 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div
              className={`${
                !scrolled
                  ? "bg-transparent shadowmd text-white"
                  : "bg-white shadowone text-black"
              } ${
