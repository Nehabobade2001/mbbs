...
import SriStudyRequirements from './StudyRequirementsSri';
...
const SriAdmissionTimeline = () => {
  ...
  const data = {
    UG: {
      ...
      popularUniversities: [
        { src: "/api/placeholder/100/50", alt: "University of Colombo" },
        { src: "/api/placeholder/100/50", alt: "University of Kandy" },
        { src: "/api/placeholder/100/50", alt: "Imperial College Negombo" },
        { src: "/api/placeholder/100/50", alt: "Galle" },
        { src: "/api/placeholder/100/50", alt: "Haputale University" },
        { src: "/api/placeholder/100/50", alt: "University of Matara" },
      ],
    },
    Masters: {
...
export default SriAdmissionTimeline;
