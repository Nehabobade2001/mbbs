...
import CanadaTrendingArticles from './CanadaTrendingArticles';
import UniversityComparisonCanada from './UniversityComparisonCanada';
import BannerCanada from './BannerCanada';
...
const FactsGrid = () => {
  ...
  const whyStudyData = {
    ...
    description: `The Canada is home to the world's most esteemed universities and is among the popular destinations 
                  for studying abroad. Ranked as the best education systems in the world, the Canadan Education System provides 
  ...
  return (
    <>
      ...
      <CanadaTrendingArticles />
      <BannerCanada />
      <UniversityComparisonCanada />
    </>
  );
};
