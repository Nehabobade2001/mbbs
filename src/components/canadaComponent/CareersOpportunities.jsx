  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <p className="text-[#233871] mb-6 text-left">
        Studying in the Canada offers a variety of experiences. The cultural and traditional values of the Canada attract several international students every year. The popular areas of employment in Canada are as follows:
      </p>
