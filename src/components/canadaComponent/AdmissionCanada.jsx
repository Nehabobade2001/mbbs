...
import CanadaStudyRequirements from './StudyRequirementsCanda';
...
const IndAdmissionTimeline = () => {
  ...
  const data = {
    UG: {
      ...
      popularUniversities: [
        { src: "/api/placeholder/100/50", alt: "University of Guelph" },
        { src: "/api/placeholder/100/50", alt: "University of Charlottetown" },
        { src: "/api/placeholder/100/50", alt: "Imperial College Barrie" },
        { src: "/api/placeholder/100/50", alt: "Kelowna" },
...
export default IndAdmissionTimeline;
