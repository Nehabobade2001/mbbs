  ...
  const cards = [
    {
      ...
      text: "Track your TOEFL exam preparation with advanced analytics. Understand your progress with a performance matrix, accuracy chart, progress report & test-wise analysis.",
    ...
    },
    {
      ...
      text: "For every full-length test to support your TOEFL exam prep. You will get a score out of 800, so you know where you stand. The accuracy of our score predictor is +/- 20 points.",
      button: "Predict Your Score",
    },
    {
      url: "https://www.jamboreeindia.com/assets/product-page/img/study-portal/doubtsession.webp",
      title: "Doubt Clearing Sessions",
      text: "To foolproof your TOEFL prep, our online portal makes it easy to schedule doubt-clearing sessions (general or 1-on-1) at your convenience.",
      button: "Get your Doubts Cleared",
    },
    {
      url: "https://www.jamboreeindia.com/assets/product-page/img/study-portal/testingportal.webp",
      title: "TOEFL-Like Testing Portal",
      text: "The testing platform at Jamboree's portal simulates the actual TOEFL test experience to familiarize you with the testing conditions.",
      button: "Track Your Performance",
    },
  ];
