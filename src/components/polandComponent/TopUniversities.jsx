...
import Capital from '../../Images/Poland/Capital.png';
...
const FactsGrid = () => {
  const factsData = [
    { imageSrc: Capital, title: "Capital", value: "Warsaw" },
    { imageSrc: Population, title: "Population", value: "38 Mn" },
    { imageSrc: Language, title: "Language", value: "Polish" },
    { imageSrc: Students, title: "International Students", value: "105,000" },
    { imageSrc: GDP, title: "GDP", value: "$ 844.6 Billion" },
    { imageSrc: Dialing, title: "Dialing Code", value: "+48" },
    { imageSrc: Currency, title: "Currency", value: "Zioty (PLN)" },
    { imageSrc: University, title: "Universities and Colleges", value: "350" },
  ];
