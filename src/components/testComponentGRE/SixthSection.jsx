...
const SixthSection = () => {
  const cards = [
    {
      ...
      text: "Track your GRE exam preparation with advanced analytics. Understand your progress with a performance matrix, accuracy chart, progress report & test-wise analysis.",
    ...
    },
    {
      ...
      text: "For every full-length test to support your GRE exam prep. You will get a score out of 800, so you know where you stand. The accuracy of our score predictor is +/- 20 points.",
      button: "Predict Your Score",
    },
    {
      url: "https://www.jamboreeindia.com/assets/product-page/img/study-portal/doubtsession.webp",
      title: "Doubt Clearing Sessions",
      text: "To foolproof your GRE prep, our online portal makes it easy to schedule doubt-clearing sessions (general or 1-on-1) at your convenience.",
      button: "Get your Doubts Cleared",
    },
    {
      url: "https://www.jamboreeindia.com/assets/product-page/img/study-portal/testingportal.webp",
      title: "GRE-Like Testing Portal",
      text: "The testing platform at Jamboree's portal simulates the actual GRE test experience to familiarize you with the testing conditions.",
      button: "Track Your Performance",
    },
  ];
  ...
  return (
    <div className="min-h-[100vh] py-10 bg-gray-50 px-4">
      ...
      {/* GRE Prep Essentials Section */}
      <div className="text-center mt-14">
        <h1 className="text-xl sm:text-2xl lg:text-3xl font-medium text-[#3e5ba9]">
          Your {''}
          <span className="text-[#F6C16D]">GRE </span> 
           Prep Essentials
        </h1>
