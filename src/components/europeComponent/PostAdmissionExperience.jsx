...
const AdmissionInfo = () => {
  ...
  const tabContent = {
    'AFTER 12TH / UG': {
      howToApply: `Undergraduate applications to EUROPE universities are processed through the UCAS (Universities and Colleges Admissions Service) platform. UCAS allows students to apply to multiple universities in one place, streamlining the application process. You must track your application status, submit required documents, academic records, and references, securing a smooth admission.`,
      costEstimate: `Tuition fees for studying in the EUROPE range from £10,000 to £38,000 per year depending on the course and university. This converts to approximately ₹9,00,000 - ₹35,00,000 annually for Indian students.`,
      popularPrograms: [
        { icon: '👥', name: 'Business' },
    ...
    MASTERS: {
      ...
      costEstimate: `Master's programs in the EUROPE typically cost between £15,000 to £45,000 per year, varying by program and institution.`,
      popularPrograms: [
    ...
    MBA: {
      ...
      costEstimate: `MBA programs in the EUROPE range from £20,000 to £60,000 for the full program, with additional living expenses.`,
      popularPrograms: [
