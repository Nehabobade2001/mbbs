        ...
        <div className=" h-full w-auto max-w-[46rem] items-center justify-center bg-background overflow-hidden pt-48 ">
          <BoxReveal boxColor={"transparent"} duration={0.5}>
            <p className="text-[3.5rem] leading-tight text-[#3e5ba9] whitespace-pre-wrap font-semibold">
              ...
              <span className="text-[#f6c16f]">.</span>
            </p>
          </BoxReveal>
          ...
          <BoxReveal boxColor={"transparent"} duration={0.5}>
            <h2 className="mt-[.5rem] text-[1rem]">
              ...
              <span className="text-[#f6c16f]">Entrance Exams </span> to{" "}
          ...
          <BoxReveal boxColor={"transparent"} duration={0.5}>
            <div className="mt-[1.5rem]">
              <p>
                At
                <span className="font-semibold text-[#f6c16f]">
                  {" "}
                  Aspirants Ally
                </span>
                , We provide professional counseling and a proven track record,
                Aspirant’s Ally (MBBSWALA) offers expert guidance for both UG
                and PG medical aspirants. Plan your future with confidence."
              </p>
            </div>
          </BoxReveal>
          <div className="flex items-end gap-4">
            <BoxReveal boxColor={"transparent"} duration={0.5}>
              <ShimmerButton className="mt-[1.6rem]">
