...
const SeventhSection = () => {
  return (
    <div className="min-h-[100vh] bg-gray-50 py-10">
      ...
      <div className="flex flex-col lg:flex-row items-center h-[80vh] px-4">
        ...
        <div className="flex flex-col justify-center items-center lg:w-1/2 w-full text-center">
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-semibold lg:w-[30vw]">
            Aspirant's Ally Offers Everything You Need For A Smart IELTS Exam Preparation
          </h1>
          <button className=" text-white py-2 px-6 mt-6 ">
            <ShimmerButton>
            Download IELTS Test Prep App
            </ShimmerButton>
          </button>
        </div>
        ...
        <div className="lg:w-1/2 w-full flex justify-center items-center">
          <img
            ...
            alt="IELTS Test Prep App"
          />
        </div>
      </div>

      {/* Second Section: Free IELTS Prep Resources */}
      ...
      {/* Cards Section: IELTS Quiz and Syllabus Download */}
      <div className="flex flex-col lg:flex-row justify-center gap-8 mt-12 px-6 sm:px-12 lg:px-24">
        <Card3
          value={{
            ...
            title: "IELTS Quiz",
            text: "Take the IELTS preparation test and begin your IELTS preparation online now",
            button: "Take IELTS Quiz",
          }}
        />
        ...
        <Card3
          value={{
            ...
            text: "Download the IELTS syllabus now and get a head start on your IELTS preparation",
            button: "Download IELTS Syllabus",
          }}
        />
      </div>
    </div>
