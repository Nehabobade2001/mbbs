...
import IndStudyRequirements from './StudyRequirementsInd';
...
const IndAdmissionTimeline = () => {
  ...
  const data = {
    UG: {
      ...
      popularUniversities: [
        { src: "/api/placeholder/100/50", alt: "University of Bhopal" },
        { src: "/api/placeholder/100/50", alt: "University of Indore" },
        { src: "/api/placeholder/100/50", alt: "Imperial College Indore" },
        { src: "/api/placeholder/100/50", alt: "RGPV" },
