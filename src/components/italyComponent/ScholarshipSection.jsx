...
const scholarships = [
  {
    ...
    description:
      "The British Chevening Scholarships offer fully funded opportunities for outstanding international students to pursue a master's degree in the ITALY. Funded by the ITALY government, these prestigious scholarships cover tuition fees, travel, and living expenses, empowering future leaders to develop professionally and academically.",
  },
  {
    step: 2,
  ...
  },
  {
    ...
    description:
      "The Charles Wallace India Trust Scholarships provide funding for Indian professionals and artists to pursue short-term study, research, or artistic projects in the ITALY. These scholarships cover accommodation and travel costs.",
  },
  {
    step: 5,
  ...
  return (
    <div className="relative overflow-hidden mt-20 px-4 sm:px-6 lg:px-10">
      ...
      <p className="text-center text-gray-600 mx-auto max-w-4xl mb-8">
        There are various scholarships offered by the ITALY government, universities, and private organizations to support the education of international students. Here's a list of the most popular scholarships to study in the ITALY.
      </p>
