...
import ds from "../../Images/white Logo aspirent ally.png";
const FooterNew = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-[#233871] rounded-t-3xl relative opacity-100 m-4 z-10">
        <div className="bg-[#233871] rounded-2xl p-4 py-6 mx-auto grid md:grid-cols-3 gap-8">
          <div className="flex flex-col space-y-4 border-b md:border-r-2">
            ...
            <p className="text-gray-100 font-light px-8">
              We provide top-notch services to enhance your skills. Join us and explore our professional courses tailored to your needs.
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <ul className="space-y-3 text-gray-100 font-light">
              <li>
                <Link to="/privacy-policy" className="hover:text-yellow-300 transition">Privacy Policy</Link>
              </li>
              <li>
                <Link to="/terms-and-conditions" className="hover:text-yellow-300 transition">Terms & Conditions</Link>
              </li>
              <li>
                <Link to="/digital-marketing" className="hover:text-yellow-300 transition">Digital Marketing</Link>
              </li>
              <li>
                <Link to="/ui-ux-design" className="hover:text-yellow-300 transition">UI/UX Design</Link>
              </li>
            </ul>
          </div>
          ...
          <ul className="space-y-3 text-gray-100 font-light">
            ...
            <li>
              <Link to="/courses" className="hover:text-yellow-300 transition">View Courses</Link>
            </li>
            <li>
              <Link to="/neet-predictor" className="hover:text-yellow-300 transition">NEET Predictor</Link>
            </li>
            <li>
              <Link to="/partnership" className="hover:text-yellow-300 transition">Partnership</Link>
            </li>
          </ul>
          </div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between border-t py-4 gap-2 mt-9">
