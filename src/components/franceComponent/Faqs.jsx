  ...
  const faqs = [
    {
      ...
      answer: "The fees for courses vary across different universities in the France. The average cost of UG courses in France range from £9,000- 30,000 (INR 9,00,000-30,00,000). The fees for PG courses is around £15,000-35,000 (INR 15,00,000-35,00,000). MBA courses in France cost around £12,000- 80,000 (INR 12,00,000-80,00,000)."
    },
    {
    ...
    {
      question: "Can one work part-time while studying in France?",
    ...
    {
      question: "What is the minimum percentage required to study in the France?",
    ...
    {
      question: "Which are the best courses to study in the France?",
    ...
    {
      question: "Which are the top universities in the France?",
      answer: "Some top universities include Oxford, Cambridge, Imperial College London, UCL, and LSE, among others."
    },
    {
      question: "How long can one stay after studying in the France?",
