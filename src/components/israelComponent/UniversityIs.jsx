...
import IsTrendingArticles from './IsTrendingArticles';
import UniversityComparisonIs from './UniversityComparisonIs';
import BannerIs from './BannerIs';
...
const FactsGrid = () => {
  // Facts data array
  const factsData = [
    { imageSrc: 'data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3…271.1%27%20width=%27346%27%20height=%27215%27/%3e', title: "Capital", value: "London" },
    { imageSrc: 'https://blogassets.leverageedu.com/media/uploads/2022/07/15172913/Audencia-Business-School-Acceptance-Rate.png', title: "Population", value: "68 Mn" },
  ...
  const whyStudyData = {
    title: "Why Study in Israel?",
    description: `The Israel is home to the world's most esteemed universities and is among the popular destinations 
                  for studying abroad. Ranked as the best education systems in the world, the Israeln Education System provides 
