...
import Capital from '../../Images/Spain/Capital.png';
...
const FactsGrid = () => {
  const factsData = [
    { imageSrc: Capital, title: "Capital", value: "Madrid" },
    { imageSrc: Population, title: "Population", value: "48.7 Mn" },
    { imageSrc: Language, title: "Language", value: "Spanish (Castilian)" },
    { imageSrc: Students, title: "International Students", value: "224,080" },
    { imageSrc: GDP, title: "GDP", value: "$ 1.43 Trillion" },
    { imageSrc: Dialing, title: "Dialing Code", value: "+34" },
    { imageSrc: Currency, title: "Currency", value: "Euro" },
    { imageSrc: University, title: "Universities and Colleges", value: "112" },
  ];
